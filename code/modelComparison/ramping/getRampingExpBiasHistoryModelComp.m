function [WAIC, DIC, l_like, trial_WAIC, trial_DIC, trial_l_like, sample_likelihoods, sample_trial_likelihoods ] = getRampingExpGLMBiasTrialComp(RampSamples,params,modelFit,timeSeries)
...
[l_like,trial_l_like] = kcRampLikelihoodExpGLMBias(gpu_y, gpu_trIndex, gpu_trBetaIndex, gpu_spe, betas, w2s, l_0, gamma, timeSeries.delta_t, params.DIC.meanLikelihoodSamples, bias);
