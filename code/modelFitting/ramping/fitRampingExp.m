...
function [ RampFit, RampSamples, LatentDataHandler] = fitRampingExp(timeSeries,params)
...
for ss = 2:totalSamples
    ...
    kcRampPathSamplerExp(gpu_lambdaN,gpu_auxThresholdN,gpu_y,gpu_trIndex,gpu_trBetaIndex,RampSamples.betas(ss-1,:),RampSamples.w2s(ss-1),RampSamples.l_0(ss-1),RampSamples.gammas(ss-1),timeSeries.delta_t, params.rampSampler.numParticles, params.rampSampler.minNumParticles,params.rampSampler.sigMult,maxTrLength, c, p);    
    ...
    [log_p_lambda, der_log_p_y, G_log_p_y] = kcRampBoundHeightSamplerExp(gpu_lambdaN,gpu_auxThresholdN,gpu_y,gpu_trIndex,RampSamples.gammas(ss-1),timeSeries.delta_t,G_prior,der_log_prior);
    ...
    [log_p_lambda_star, der_log_p_y_star, G_log_p_y_star] = kcRampBoundHeightSamplerExp(gpu_lambdaN,gpu_auxThresholdN,gpu_y,gpu_trIndex,gamma_star,timeSeries.delta_t,G_prior_star,der_log_prior_star);
