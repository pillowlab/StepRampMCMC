...
function [ RampFit, RampSamples, LatentDataHandler] = fitRampingPowerBias(timeSeries,params,pow)
...
for ss = 2:totalSamples
    ...
    kcRampPathSamplerPowerBias(gpu_lambdaN,gpu_auxThresholdN,gpu_y,gpu_trIndex,gpu_trBetaIndex,RampSamples.betas(ss-1,:),RampSamples.w2s(ss-1),RampSamples.l_0(ss-1),RampSamples.gammas(ss-1),timeSeries.delta_t, params.rampSampler.numParticles, params.rampSampler.minNumParticles,params.rampSampler.sigMult,maxTrLength, c, p, RampSamples.biases(ss-1), pow);
...
[log_p_lambda, der_log_p_y, G_log_p_y, der_log_p_y_bias, G_log_p_y_bias, G_off_diag] = kcRampBoundHeightSamplerPowerBias(gpu_lambdaN,gpu_auxThresholdN,gpu_y,gpu_trIndex,RampSamples.gammas(ss-1),timeSeries.delta_t,G_prior,der_log_prior,RampSamples.biases(ss-1),bias_g,bias_l,pow);
...
p_sig = (g_delta^2)*inv(G);
    ...
    if bias_star > 0
        ...
        [log_p_lambda_star, der_log_p_y_star, G_log_p_y_star, der_log_p_y_bias_star, G_log_p_y_bias_star, G_off_diag_star] = kcRampBoundHeightSamplerPowerBias(gpu_lambdaN,gpu_auxThresholdN,gpu_y,gpu_trIndex,gamma_star,timeSeries.delta_t,G_prior_star,der_log_prior_star,bias_star,bias_g_star,bias_l_star,pow);
